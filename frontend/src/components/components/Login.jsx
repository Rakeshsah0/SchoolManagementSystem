...
const Login = (setnavandfooter) => {
  ...
  return (
    <div>
      ...
      <h1>{profile}</h1>
      Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vel ipsum vero inventore minima, exercitationem alias assumenda porro ab quo! At qui ut aliquam impedit voluptatum veritatis iusto architecto praesentium animi, numquam eligendi dolorum in sequi debitis reprehenderit non doloribus, quidem fugit. Possimus deserunt dolore, consequuntur iusto totam cupiditate sapiente veniam dolores consequatur aspernatur rem repellat voluptatem molestiae quam ea, ex rerum eius sed, doloribus nesciunt aut quidem accusantium molestias similique. Quae iste, ratione dolore repudiandae alias asperiores. Quam accusantium eveniet voluptate, enim optio laborum. Facere dolores consectetur rem, perspiciatis, earum iste consequuntur ut natus nemo molestias provident, quo reprehenderit fuga.
